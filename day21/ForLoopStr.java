...
public class ForLoopStr {
    ...
    /*
	 * Let's say 'a' and 'A' is special char Find out how many 'a' and 'A' in the
	 * str argument and return that number
	 * 
	 * 1. Create a numeric variable that should hold the count 2. Loop over str
	 * string and check if char is 'A' or 'a' 3. if yes increase your count by one
	 * 4. if not just go to the next char 5. After the loop return result count.
	 * 
	 */
...
return count;
    ...
    /*
	 * print each char of str argument in the new line for loop charAt(i)
	 */
