...
public class StrContains {
	public static void main(String[] args) {
    	...
    	String topic2 = "Java Is Good!";
    	boolean Ja = topic2.contains("Java Is Good");
    	System.out.println(Ja);
    	
    	System.out.println(topic2.contains("Java")); // true
    	System.out.println(topic2.contains("Python")); // false
    }
}
