...
public class LogicalOperators {
	public static void main(String[] args) {
		...
		System.out.println("in range: " + inRange); // -> in range: true
		...
		System.out.println("is out number: " + isOurNumber);// -> is out number: true
		...
		System.out.println(isGood); // true
		                            // !
		System.out.println("NOT 1: " + !true); // NOT 1: false
		System.out.println("NOT 2: " + !false);// NOT 2: true
		
/*
		 * false || true || false => 1. true   = because 1 of them is true answer must be true.
 * true && true           => 2. true   = all of them is true when everything is true.
 * false && true && true  => 3. false  = one of them is false answer will be true.
 * !false                 => 4. true   = reverse the logical value answer will be true or opposite
 * !true                  => 5. false
 */
